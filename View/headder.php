                    ...
                    <nav class="navbar navbar-expand-lg n navbar-light bg-light" style="margin-bottom: 0px; ">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            if(isset($_SESSION['makh'])&&isset($_SESSION['tenkh'])){
                               ...
                               echo '<a href="index.php?action=login" class="nav-link">Đăng Nhập</a>'
                            ?>
                            </li>
                            <li class="nav-item">
                            ...
                            ?>
                         <p style="color: red; margin-top: 20px; margin-left: 0px;"><?php echo 'Xin chao '.$name ?></p>
                         <?php
                         else:
                            echo '<p style="color: red; margin-top: 20px; margin-left: 0px;">Xin chao</p>';
                         ?>
                         <?php
                            endif;
                         ?>
